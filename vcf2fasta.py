####FROM https://github.com/aihardin/utils/blob/master/vcf2fasta.py USED WITH SLIGHT MODIFICATIONS
#! /usr/bin/env python
import os
import sys
...
def main(argv):
    ...
    new_chrs = insertSNPs(subs, False, chrs)
